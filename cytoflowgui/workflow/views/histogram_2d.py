...
Histogram2DView.__repr__ = cytoflow_class_repr
...
class Histogram2DWorkflowView(WorkflowFacetView, Histogram2DView):
...
@camel_registry.dumper(Histogram2DPlotParams, '2d-histogram-params', version = 2)
